...
# Y_hat  = 0.000017MRICount + 2.486GenderMale
...
# No, it doesn't appear to be a good model. Looking at the Adjusted R-Squared, only about 28.26% of the variation in the IQ could be explained by the model. Additionally, none of MRICount and GenderMale are significant that is, they do no have any effect on the model.
